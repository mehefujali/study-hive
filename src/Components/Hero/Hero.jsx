...
const Hero = () => {
      ...
      return (
            <div className={` relative  ${theme === "dark" ? 'hero-bg-dark':'hero-bg'}     pt-24`}>
                  ...
                  <div className="container relative w-11/12 dark:text-white mx-auto flex flex-col lg:flex-row justify-between items-center gap-8">
                        ...
                        <div className=" w-full lg:w-5/12 flex flex-col gap-4">
                              ...
                              <p className=" text-gray-500 dark:text-white dark:text-white ">{`Welcome to StudyMate, the ultimate platform for students to study together, complete assignments, and help each other grow. Whether you're looking to collaborate on projects, get feedback on your work, or simply share knowledge with friends, our platform makes learning fun and effective. Join us today and take your learning to the next level!`}</p>
                        ...
                        <div className=' img-bg relative'>
                              <div className=' text-black dark:text-white font-semibold p-1 md:p-4 absolute backdrop-blur-sm flex items-center gap-1 border-white border-2 rounded-lg bottom-10 md:bottom-1/3 bg-primary-color2  bg-opacity-35 '><FaPeopleGroup className=' text-3xl' /> Work together with your group </div>
