...
const Newslatter = () => {
  ...
  return (
    <div className=" my-14">
      <div
        className=" container mx-auto h-96 bg-indigo-700 w-full  flex items-center justify-center text-center rounded-xl"
        id="newslater-contenar"
      >
        <div className=" space-y-3 ">
          ...
          <form onSubmit={handleNewsLatterSignIn} className=" join">
            <input
              ...
              name="email"
              id=""
              className="input w-11/12 join-item focus:outline-none focus:border-none"
            />
